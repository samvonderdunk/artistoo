...
def openruns(fname='Mitochondrialog.txt', folder='current', selector=None, verbose=False, sortbykeywordix=[], sortbylineix=[], longform=False, **kwargs):
    ...
    dfs = {}
    for ix, subdir in  enumerate(sorted([os.path.join(folder, dirname) for dirname in os.listdir(folder)])):
