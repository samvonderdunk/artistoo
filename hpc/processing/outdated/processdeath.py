...
def readfile(fname, selector, start=None, stop=None, verbose = True, reverse=False, **kwargs):
    ...
    while line:
        ...
        if line[0] == "{":
            it += 1
            selectorline = line
            selected = selector(selectorline)
...
def openruns(fname='deaths.txt', folder='current', selector=None, verbose=False, sortbykeywordix=[], sortbylineix=[], longform=False, **kwargs):
